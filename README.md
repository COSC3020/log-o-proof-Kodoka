...
and $a$, $b \neq 1$. As $\log_{b} a$ is a constant value for any given $a$, $b$ satisfying the previously  
established conditions, we can represent $\frac{1}{\log_{b} a}$ as a constant, $c$.  
Thus $\log_{a} n=c \cdot \log_{b} n$
